...
const objLat = (obj) => {
    ...
    const {firstName, lastName, age, hobby} = obj;  // make the inner contect easier to read 
    const first = firstName.charAt(0).toUpperCase() + firstName.slice(1); 
    const second = lastName.charAt(0).toUpperCase() + lastName.slice(1);
                                                                  // to let first and second name upper
    return `my name is ${first} ${second} I am ${age} YO, and I love ${hobby}.`;
};
// -------------------------------------------------------------------------------------------------------
